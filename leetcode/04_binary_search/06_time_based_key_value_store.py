...
class TimeMap:
    ...
    def get(self, key: str, timestamp: int) -> str:
        ...
        if timestamp >= self.dict[key][right][0]:
...
obj = TimeMap()
obj.set('key1','value1',5)
obj.set('key1','value10',10)
obj.set('key1','value14',14)
param_2 = obj.get('key1',11)
print(param_2)